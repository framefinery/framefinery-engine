...
FrameFinery Engine is run as AV2 lossless with `--set predictive`. At this point the
...
FrameFinery Engine command shape:
...
| Vector | FrameFinery Engine Mbps | ffmpeg Mbps | Bitrate ratio | FrameFinery Engine fps | ffmpeg fps | FPS ratio |
|---|---:|---:|---:|---:|---:|---:|
...
- Frames: 300.
- FrameFinery Engine bytes: 297,043,630.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine elapsed: 35.021 s.
...
The first NEWMV plus mixed 8x8 inter-tile checkpoint reduced FrameFinery Engine bytes
to 188,690,766 for the same 300 frames, with total FrameFinery Engine encode speed at
...
- Frames: 300.
- FrameFinery Engine bytes: 188,690,766.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 3.97 fps.
...
- FrameFinery Engine bytes: 188,690,766.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.04 fps.
...
- FrameFinery Engine bytes: 188,690,766.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.15 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 98,082,071.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 6.23 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 97,914,909.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 5.97 fps.
...
- FrameFinery Engine bytes: 97,914,909.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 6.06 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 85,632,514.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 3.96 fps.
...
- FrameFinery Engine bytes: 85,632,514.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.14 fps.
...
- FrameFinery Engine bytes: 85,632,514.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.25 fps.
...
- FrameFinery Engine bytes: 85,632,514.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.40 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 85,640,870.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.45 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 85,640,910.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.70 fps.
...
- FrameFinery Engine bytes: 85,640,910.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 4.89 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 86,542,077.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 5.88 fps.
...
- FrameFinery Engine bytes: 86,542,077.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 5.93 fps.
...
- FrameFinery Engine bytes: 86,542,077.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 9.53 fps.
...
- FrameFinery Engine bytes: 86,542,077.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 9.89 fps.
...
- FrameFinery Engine bytes: 86,542,077.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 10.10 fps.
...
- Frames: 300.
- FrameFinery Engine bytes: 85,648,119.
- ffmpeg/libaom bytes: 3,394,010.
- FrameFinery Engine aggregate speed: 8.80 fps.
