...
|---|---|---|---|---|
| `yuv420p8`, `yuv420p10le` | native lossy/lossless | native lossy/lossless | exact for both codecs | Shared raw metadata requires even width and height. AV2 and VVC accept legal visible dimensions and pad internally to their current coded-canvas granularity. |
| `yuv422p8`, `yuv422p10le` | native lossy/lossless | native lossy/lossless | exact for both codecs | Shared raw metadata requires even width. AV2 and VVC accept legal visible dimensions and pad internally to their current coded-canvas granularity. |
| `yuv444p8`, `yuv444p10le`, `gbrp8` | native lossy/lossless | native lossy/lossless | exact for both codecs | AV2 and VVC accept non-zero visible dimensions and pad internally to their current coded-canvas granularity. |
