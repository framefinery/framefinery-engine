...
| VVC residual prediction | 1,139-line orchestration plus focused prediction siblings | CCLM orchestration and shared angular/reference machinery still need call-graph review |
