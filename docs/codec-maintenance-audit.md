...
| AV2 tile transform syntax helpers | 928-line transform/quant core plus 672-line coefficient syntax, 360-line chroma, 320-line context, and 677-line low-level writer siblings | skip-field name/CDF/key selection is now paired behind one symbol emitter; remaining high-range, DC-level, and context helpers should be grouped only after syntax-by-syntax equivalence review |
