...
const DEFAULT_TXFM_DO_PARTITION_INTRA_8X8_CDF: [u16; 6] = avm_cdf2(29620, 0, 0, 0);
const DEFAULT_TXFM_4WAY_PARTITION_INTRA_8X8_CDF: [u16; 11] =
    avm_cdf7(32744, 32748, 32752, 32756, 32760, 32764, -2, -2, 0);
const DEFAULT_TXFM_DO_PARTITION_INTER_8X8_CDF: [u16; 6] = avm_cdf2(32393, -1, 0, 0);
const DEFAULT_TXFM_4WAY_PARTITION_INTER_8X8_CDF: [u16; 11] =
    avm_cdf7(10790, 22602, 32736, 32740, 32744, 32748, -1, -1, -2);
const DEFAULT_INTER_EXT_TX_DCT_IDTX_4X4_CDF: [u16; 6] = avm_cdf2(16384, 0, 0, 0);
...
const DEFAULT_TXB_SKIP_Y_INTER_TX4X4_CTX1_CDF: [u16; 6] = avm_cdf2(10751, 0, 1, -1);
const DEFAULT_TXB_SKIP_Y_INTER_TX4X4_CTX2_CDF: [u16; 6] = avm_cdf2(17579, 0, 1, -1);
const DEFAULT_TXB_SKIP_Y_INTER_TX4X4_CTX3_CDF: [u16; 6] = avm_cdf2(24060, 1, 1, 0);
const DEFAULT_TXB_SKIP_Y_INTER_TX4X4_CTX4_CDF: [u16; 6] = avm_cdf2(28085, 0, -1, 0);
const DEFAULT_TXB_SKIP_Y_INTER_TX4X4_CTX5_CDF: [u16; 6] = avm_cdf2(30928, 1, 1, 1);
