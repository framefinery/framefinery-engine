...
const VVC_DCT2_DC_16: [i32; 16] = [64; 16];
const VVC_DCT2_DC_32: [i32; 32] = [64; 32];
...
pub(in crate::vvc) fn quantize_vvc_luma_residual_greedy_with_qp_and_mts_into(
    residuals: &[i16],
    width: u16,
    height: u16,
    bit_depth: SampleBitDepth,
    ...
    quantize_vvc_luma_residual_greedy_with_qp_and_mts_inner(
        residuals,
        width,
        height,
        bit_depth,
        qp,
        mts_index,
        VvcLumaAcCandidateSearch::Full,
        transform_scratch,
        reconstructed_residual,
    )
}

pub(in crate::vvc) fn quantize_vvc_luma_residual_fast_with_qp_and_mts_into(
    residuals: &[i16],
    width: u16,
    height: u16,
    bit_depth: SampleBitDepth,
    ...
    quantize_vvc_luma_residual_greedy_with_qp_and_mts_inner(
        ...
        qp,
        mts_index,
        VvcLumaAcCandidateSearch::FastModeDecision,
        transform_scratch,
        reconstructed_residual,
    )
}

fn quantize_vvc_luma_residual_greedy_with_qp_and_mts_inner(
    residuals: &[i16],
    width: u16,
    height: u16,
    bit_depth: SampleBitDepth,
    ...
    let (ac_coeffs, has_ac) = quantize_direct_luma_ac_coeffs_into(
        residuals,
        width,
        height,
        bit_depth,
...
fn quantize_vvc_luma_residual_dc_by_search(
    ...
    let unit = dc_only_residual_from_level_with_params(1, width, height, bit_depth, dequant_params);
    if unit == 0 {
...
include!("transform_luma_ac_selection.rs");
include!("transform_luma_ac_candidates.rs");
...
pub(in crate::vvc::residual) fn luma_reconstructed_residual_sse_with_mts_into(
    source_residuals: &[i16],
    width: u16,
    height: u16,
    bit_depth: SampleBitDepth,
...
include!("transform_luma_ac_math.rs");

include!("transform_chroma_ac.rs");
...
include!("transform_math.rs");

include!("transform_dequant.rs");

include!("transform_basis.rs");
